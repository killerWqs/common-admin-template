...
;layui.define("view", function (e) {
    var a = layui.jquery, t = layui.laytpl, i = layui.element, n = layui.setter, l = layui.view, s = layui.device(),
        r = a(window), o = a("body"), u = a("#" + n.container), c = "layui-show", d = "layui-this",
        y = "layui-disabled", m = "#LAY_app_body", f = "LAY_app_flexible", h = "layadmin-side-spread-sm",
        p = "layadmin-tabsbody-item", v = "layui-icon-shrink-right", b = "layui-icon-spread-left",
        g = "layadmin-side-shrink", x = "LAY-system-side-menu", C = {
            v: "1.2.1 pro", req: l.req, exit: l.exit, escape: function (e) {
                ...
                var t, i = e.seconds, n = function (l) {
                    var s = a(e.elem);
                    i--, i < 0 ? (s.removeClass(y).html("获取验证码"), i = e.seconds, clearInterval(t)) : s.addClass(y).html(i + "秒后重获"), l || (t = setInterval(function () {
                        n(!0)
                    }, 1e3))
                };
                o.off("click", e.elem).on("click", e.elem, function () {
                    ...
                    if (i === e.seconds && !a(this).hasClass(y)) {
                        if (!/^1\d{10}$/.test(l)) return t.focus(), layer.msg("请输入正确的手机号");
                ...
                var t = u, i = a("#" + f), l = C.screen();
                "spread" === e ? (i.removeClass(b).addClass(v), l < 2 ? t.addClass(h) : t.removeClass(h), t.removeClass(g)) : (i.removeClass(v).addClass(b), l < 2 ? t.removeClass(g) : t.addClass(g), t.removeClass(h)), layui.event.call(this, n.MOD_NAME, "side({*})", {status: e})
                ...
                var a = n.theme;
                e = e || 0, a.color[e] && (a.color[e].index = e, C.theme({color: a.color[e]}))
            }, tabsPage: {}, tabsHeader: function (e) {
                return a("#LAY_app_tabsheader").children("li").eq(e || 0)
            }, tabsBody: function (e) {
                return a(m).find("." + p).eq(e || 0)
            }, tabsBodyChange: function (e) {
                C.tabsHeader(e).attr("lay-attr", layui.router().href), C.tabsBody(e).addClass(c).siblings().removeClass(c), k.rollPage("auto", e)
            }, resize: function (e) {
                var a = layui.router(), t = a.path.join("-");
                C.resizeFn[t] && (r.off("resize", C.resizeFn[t]), delete C.resizeFn[t]), "off" !== e && (e(), C.resizeFn[t] = e, r.on("resize", C.resizeFn[t]))
            ...
            flexible: function (e) {
                ...
                e.off("keypress").on("keypress", function (a) {
                    if (this.value.replace(/\s/g, "") && 13 === a.keyCode) {
                        ...
                        t += this.value, i = i + ' <span style="color: #FF5722;">' + C.escape(this.value) + "</span>", location.hash = C.correctRouter(t), k.serach.keys || (k.serach.keys = {}), k.serach.keys[C.tabsPage.index] = this.value, this.value === k.serach.keys[C.tabsPage.index] && k.refresh(e), this.value = ""
                    }
                })
            }, message: function (e) {
                ...
                var a = C.screen() < 2, t = layui.data(n.tableName).note;
                ...
                i.hasClass(a) ? (C.fullScreen(), i.addClass(t).removeClass(a)) : (C.exitScreen(), i.addClass(a).removeClass(t))
            }, about: function () {
                C.popupRight({
                ...
                e.hasClass(d) || (e.addClass(d).siblings(".layui-this").removeClass(d), C.initTheme(a))
                ...
                "all" === e ? (a(z + ":gt(0)").remove(), a(m).find("." + p + ":gt(0)").remove()) : (a(z).each(function (e, i) {
    ...
    !function () {
        ...
        e.theme ? C.theme(e.theme) : n.theme && C.initTheme(n.theme.initColorIndex), o.addClass("layui-layout-body"), C.screen() < 1 && delete n.pageTabs, n.pageTabs || u.addClass("layadmin-tabspage-none"), s.ie && s.ie < 10 && l.error("IE" + s.ie + "下访问可能不佳，推荐使用：Chrome / Firefox / Edge 等高级浏览器", {
            offset: "auto",
            id: "LAY_errorIE"
        })
        ...
        }, n = a("#" + x), l = "layui-nav-itemed", s = function (e) {
            var n = C.correctRouter(t.join("/"));
            e.each(function (e, s) {
                var r = a(s), o = i(r), u = o.list.children("dd"),
        ...
        n.find("." + d).removeClass(d), C.screen() < 2 && C.sideFlexible(), s(n.children("li"))
    ...
    var F = function (e) {
        var a = e.attr("lay-id"), t = e.attr("lay-attr"), i = e.index();
        location.hash = a === n.entry ? "/" : t || "/", C.tabsBodyChange(i)
    }, z = "#LAY_app_tabsheader>li";
    o.on("click", z, function () {
        var e = a(this), t = e.index();
        return C.tabsPage.type = "tab", C.tabsPage.index = t, "iframe" === e.attr("lay-attr") ? C.tabsBodyChange(t) : (F(e), C.runResize(), void C.resizeTable())
    ...
    var P = layui.data.resizeSystem = function () {
        layer.closeAll("tips"), P.lock || setTimeout(function () {
            C.sideFlexible(C.screen() < 2 ? "" : "spread"), delete P.lock
        }, 100), P.lock = !0
    };
    r.on("resize", layui.data.resizeSystem), e("admin", C)
});