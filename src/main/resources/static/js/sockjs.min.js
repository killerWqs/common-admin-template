    ...
    return function i(s, a, l) {
        ...
        8: [function (e, t, n) {
            ...
            var f = e("./utils/url"), r = e("./utils/event"), h = e("json3"), d = e("./facade"),
                o = e("./info-iframe-receiver"), p = e("./utils/iframe"), v = e("./location"), m = function () {
                };
        ...
        11: [function (n, o, e) {
            (function (r) {
                ...
                var i = n("events").EventEmitter, e = n("inherits"), s = n("json3"), a = n("./utils/event"),
                    l = n("./transport/iframe"), c = n("./info-iframe-receiver"), u = function () {
                    };
        ...
        12: [function (e, t, n) {
            ...
            var r = e("events").EventEmitter, o = e("inherits"), i = e("./utils/url"), s = e("./transport/sender/xdr"),
                ...
                c = e("./transport/sender/xhr-fake"), u = e("./info-iframe"), f = e("./info-ajax"), h = function () {
                };
        ...
        14: [function (_, E, e) {
            (function (i) {
                "use strict";
                _("./shims");
                var r, l = _("url-parse"), e = _("inherits"), s = _("json3"), c = _("./utils/random"),
                    t = _("./utils/escape"), u = _("./utils/url"), a = _("./utils/event"), n = _("./utils/transport"),
                    o = _("./utils/object"), f = _("./utils/browser"), h = _("./utils/log"), d = _("./event/event"),
                    p = _("./event/eventtarget"), v = _("./location"), m = _("./event/close"),
        ...
        15: [function (e, t, n) {
            "use strict";
            var o, u = Array.prototype, i = Object.prototype, r = Function.prototype, s = String.prototype, a = u.slice,
                f = i.toString, l = function (e) {
            ...
            d(u, {
                forEach: function (e) {
                    var t = p(this), n = w && c(this) ? this.split("") : t, r = arguments[1], o = -1,
                        i = n.length >>> 0;
            ...
            d(u, {
                indexOf: function (e) {
                    ...
                    if (!n) return -1;
                    var r, o, i = 0;
                    for (1 < arguments.length && (r = arguments[1], (o = +r) != o ? o = 0 : 0 !== o && o !== 1 / 0 && o !== -1 / 0 && (o = (0 < o || -1) * Math.floor(Math.abs(o))), i = o), i = 0 <= i ? i : Math.max(0, n + i); i < n; i++) if (i in t && t[i] === e) return i;
                    return -1
                }
            }, x);
            var _, E = s.split;
            2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || 1 < ".".split(/()()/).length ? (_ = void 0 === /()??/.exec("")[1], s.split = function (e, t) {
                ...
                }), 1 < o.length && o.index < n.length && u.push.apply(a, o.slice(1)), s = o[0].length, c = i, a.length >= t));) e.lastIndex === o.index && e.lastIndex++;
        ...
        17: [function (o, f, e) {
            (function (e) {
                ...
                var i = o("events").EventEmitter, t = o("inherits"), s = o("../../utils/event"),
                    a = o("../../utils/url"), l = e.XMLHttpRequest, c = function () {
                    };
                ...
                t(u, i), u.prototype._start = function (e, t, n, r) {
                    ...
                    if (r && r.noCredentials || !u.supportsCORS || (c("withCredentials"), this.xhr.withCredentials = !0), r && r.headers) for (var i in r.headers) this.xhr.setRequestHeader(i, r.headers[i]);
                ...
                !u.enabled && n in e && (c("overriding xmlhttprequest"), u.enabled = !!new (l = function () {
                    try {
        ...
        22: [function (e, t, n) {
            ...
            var r = e("inherits"), o = e("json3"), i = e("events").EventEmitter, s = e("../version"),
                a = e("../utils/url"), l = e("../utils/iframe"), c = e("../utils/event"), u = e("../utils/random"),
                f = function () {
                };
        ...
        28: [function (e, t, n) {
            "use strict";
            var r = e("inherits"), a = e("../../utils/url"), l = e("./buffered-sender"), c = e("./polling"),
                u = function () {
                };
        ...
        31: [function (t, n, e) {
            (function (i) {
                ...
                var r = t("../../utils/iframe"), s = t("../../utils/random"), a = t("../../utils/browser"),
                    o = t("../../utils/url"), e = t("inherits"), l = t("events").EventEmitter, c = function () {
                    };
        ...
        33: [function (e, t, n) {
            (function (s) {
                "use strict";
                var a, l, c = e("../../utils/random"), u = e("../../utils/url"), f = function () {
                };
        ...
        38: [function (e, t, n) {
            ...
            var i = e("../utils/event"), s = e("../utils/url"), r = e("inherits"), a = e("events").EventEmitter,
                l = e("./driver/websocket"), c = function () {
                };
            ...
            (function (f) {
                ...
                p.exports = {
                    WPrefix: "_jp", currentWindowId: null, polluteGlobalNamespace: function () {
                        ...
                        var n, r, o = f.document.createElement("iframe"), i = function () {
                        ...
                        var n, r, o, i = ["Active"].concat("Object").join("X"), s = new f[i]("htmlfile"),
                            a = function () {
        ...
        55: [function (e, a, l) {
            (function (s) {
                (function () {
                    var q = {"function": !0, "object": !0}, e = q[typeof l] && l && !l.nodeType && l,
                        D = q[typeof window] && window || this,
                        t = e && q[typeof a] && a && !a.nodeType && "object" == typeof s && s;

                    function W(e, l) {
                        e || (e = D.Object()), l || (l = D.Object());
                        var c = e.Number || D.Number, u = e.String || D.String, t = e.Object || D.Object,
                            f = e.Date || D.Date, n = e.SyntaxError || D.SyntaxError, E = e.TypeError || D.TypeError,
                            r = e.Math || D.Math, o = e.JSON || D.JSON;
                        "object" == typeof o && o && (l.stringify = o.stringify, l.parse = o.parse);
                        var j, S, T, i = t.prototype, O = i.toString, h = new f(-0xc782b5b800cec);
                        try {
                        ...
                        if (!d("json")) {
                            var p = "[object Function]", C = "[object Number]", N = "[object String]",
                                A = "[object Array]", a = d("bug-string-char-index");
                            if (!h) var k = r.floor, s = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
                                I = function (e, t) {
                                    return s[t] + 365 * (e - 1970) + k((e - 1969 + (t = +(1 < t))) / 4) - k((e - 1901 + t) / 100) + k((e - 1601 + t) / 400)
                                };
                            if ((j = i.hasOwnProperty) || (j = function (e) {
                                var n, t = {};
                                return j = (t.__proto__ = null, t.__proto__ = {"toString": 1}, t).toString != O ? function (e) {
                                ...
                                }), t = null, j.call(this, e)
                            }), S = function (e, t) {
                                var n, s, r, o = 0;
                                for (r in(n = function () {
                                    this.valueOf = 0
                                }).prototype.valueOf = 0, s = new n) j.call(s, r) && o++;
                                return n = s = null, (S = o ? 2 == o ? function (e, t) {
                                    var n, r = {}, o = O.call(e) == p;
                                    for (n in e) o && "prototype" == n || j.call(r, n) || !(r[n] = 1) || !j.call(e, n) || t(n)
                                } : function (e, t) {
                                    var n, r, o = O.call(e) == p;
                                    for (n in e) o && "prototype" == n || !j.call(e, n) || (r = "constructor" === n) || t(n);
                                    (r || j.call(e, n = "constructor")) && t(n)
                                } : (s = ["valueOf", "toString", "toLocaleString", "propertyIsEnumerable", "isPrototypeOf", "hasOwnProperty", "constructor"], function (e, t) {
                                    var n, r, o = O.call(e) == p,
                                        i = !o && "function" != typeof e.constructor && q[typeof e.hasOwnProperty] && e.hasOwnProperty || j;
                                ...
                                var v = {92: "\\\\", 34: '\\"', 8: "\\b", 12: "\\f", 10: "\\n", 13: "\\r", 9: "\\t"},
                                    P = function (e, t) {
                                        ...
                                        if ("object" == typeof a && a) if ("[object Date]" != (l = O.call(a)) || j.call(a, "toJSON")) "function" == typeof a.toJSON && (l != C && l != N && l != A || j.call(a, "toJSON")) && (a = a.toJSON(e)); else if (-1 / 0 < a && a < 1 / 0) {
                                            if (I) {
                            ...
                            if (!d("json-parse")) {
                                var m, b, y = u.fromCharCode, g = {
                                    ...
                                    if ("$" == e && w(), "string" == typeof e) {
                                        ...
                                        if ("[" == e) {
                                            for (t = []; "]" != (e = x()); n || (n = !0)) n && ("," == e ? "]" == (e = x()) && w() : w()), "," == e && w(), t.push(_(e));
                                            return t
                                        }
                                        if ("{" == e) {
                                            for (t = {}; "}" != (e = x()); n || (n = !0)) n && ("," == e ? "}" == (e = x()) && w() : w()), "," != e && "string" == typeof e && "@" == (a ? e.charAt(0) : e[0]) && ":" == x() || w(), t[e.slice(1)] = _(x());
                                            return t
                                        }
                                        w()
                                    }
                                    ...
                                    var r, o = e[t];
                                    if ("object" == typeof o && o) if (O.call(o) == A) for (r = o.length; r--;) U(o, r, n); else S(o, function (e) {
                                        U(o, e, n)
                                    });
                                    return n.call(e, t, o)
                                };
        ...
        58: [function (e, t, n) {
            (function (i) {
                "use strict";
                var d = e("requires-port"), p = e("querystringify"), n = /^([a-z][a-z0-9.+-]*:)?(\/\/)?([\S\s]*)/i,
                    s = /^[A-Za-z][A-Za-z0-9+-.]*:\/\//, v = [["#", "hash"], ["?", "query"], function (e) {
                        return e.replace("\\", "/")
                ...
                function m(e) {
                    ...
                    if ("blob:" === e.protocol) r = new y(unescape(e.pathname), {}); else if ("string" === o) for (t in r = new y(e, {}), a) delete r[t]; else if ("object" === o) {
