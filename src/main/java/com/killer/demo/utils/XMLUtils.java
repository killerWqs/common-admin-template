...
//            System.out.println("lastContents:"+cellPosition+";"+lastContents);
     ...
     * @return
     */
    public static void excel2ObjByEE(ExcelConfig excelConfig, String[] excelPaths) {
...
//        需要有合并xml文件的功能，以及筛选xml文件的工具
        String[] filePaths = {"C:\\Users\\Administrator\\Desktop\\20181107.xlsx"};
        ...
        // 数据库名是不能用数字的
        excel2ObjByEE(excelConfig, filePaths);
